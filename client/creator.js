...
function createClick(){
	sendAjax("/app", "headgear=" +headgearindex+ "&skintone=" +skintoneindex+ "&archtype=" +bodyindex+ "&strength=" +strength+ "&agility="  +agility+ "&health="   +health+ "&_csrf="  + $("input[name='_csrf']").val());
}
